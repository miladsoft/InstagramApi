...
using InstaSharpApi;
using InstaSharpApi.Models;

namespace InstaSharpApiExample
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            uploader.UploadImage(@"fullPathToImage", "#helloworld");
            Console.WriteLine("Your DeviceID is " + InstaSharpApi.Properties.Settings.Default.deviceId);
            Console.Read();
        }
